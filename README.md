...
- **Published by:** LF Digital Ventures, *société par actions simplifiée* (SAS), share capital €2, RCS Nanterre 106 243 355, SIRET 106 243 355 00018, intra-community VAT FR 08 106 243 355, registered office 63 rue Nationale, 92100 Boulogne-Billancourt, France. App positioned as an **information tool only** (no betting operator, no licence). No individual's name appears in the published documents by design.
- **Placeholders to confirm or replace before launch:**
  - `contact@dycers.com` — single contact address used across all documents (swap if you register a different one).
  - The "Last updated" / "Effective date" — set to 19 June 2026; update on every revision.
- **What you still need to do before going live:**
  1. **Have a French lawyer review these.** I wrote them carefully but I am not your lawyer; for a paid product you don't want to ship legal text without a human pass.
  2. ✅ **Company registered** — LF Digital Ventures (SAS), details above. ⚠️ These three documents intentionally name no individual, but French law (LCEN art. 6) still requires a separate **Mentions légales** page that names a *directeur de la publication* (by default the SAS President). Add that page before launch.
